...
gitblame_string (WEdit *edit, char *s, int w, const char *fname)
{
    ...
    memset(&git_commit_hash, 0, sizeof(git_commit_hash));
    memset(&git_author, 0, sizeof(git_author));
    memset(&git_author_email, 0, sizeof(git_author_email));
    memset(&git_date, 0, sizeof(git_date));
    memset(&git_tz, 0, sizeof(git_tz));
    memset(&git_title, 0, sizeof(git_title));
...
fill:
    g_snprintf (s, w, "Blame: %s %s %s %s %s - %s",
                git_commit_hash[0] ? git_commit_hash : "<commit>",
                git_author[0] ? git_author : "<author>",
                git_author_email[0] ? git_author_email : "<email>",
                git_date[0] ? git_date : "<date>",
                git_tz[0] ? git_tz : "<tz>",
                git_title[0] ? git_title : "<title>");
exit:
